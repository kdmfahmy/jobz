...
- **Career narrative coherence:** the CV must read as a logical progression — if a title signals leadership (e.g. "Team Lead"), at least one bullet in that role must reflect it (team size, mentorship, direction). Never let team leadership appear for the first time in a more senior role when an earlier role already carried a leadership title. The reader should see responsibility growing across roles, not appearing out of nowhere.
